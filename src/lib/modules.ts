...
export const modules: LabModule[] = [
  {
    ...
    category: "pismi",
    tagline: "Docker · установка на любой системе",
    description:
      "Установка и настройка Docker на Windows, WSL 2, macOS и Linux — с командами, проверкой и граблями каждой конфигурации, — плюс готовые файлы работы: окружение и страница с ФИО и группой.",
    hasVariants: false,
    source: "Проектування інформаційних систем в мережах Інтернет, ЛР1, с. 3–8",
    size: "md",
  },
  {
    slug: "pismi-lab2",
    ...
    category: "pismi",
    tagline: "15 вариантов · расчёт и готовые файлы",
    description:
      "По номеру варианта: расчёт обоих выражений с журналом промежуточных величин, задание второй программы с его параметрами и готовые файлы работы — docker-compose.yml и исходники PHP.",
    hasVariants: true,
    variantCount: 15,
    source: "Проектування інформаційних систем в мережах Інтернет, ЛР2, с. 12–15",
    size: "lg",
  },
  {
    slug: "pismi-lab3",
    ...
    category: "pismi",
    tagline: "три контейнера · справочник с CRUD",
    description:
      "Окружение из PHP, MySQL и phpMyAdmin и справочник с четырьмя операциями над записями: порядок запуска, известные грабли и готовые файлы, включая запрос создания таблицы.",
    hasVariants: false,
    source: "Проектування інформаційних систем в мережах Інтернет, ЛР3, с. 17–27",
    size: "md",
  },
  {
