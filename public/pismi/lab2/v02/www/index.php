...
ust_head('ЛР2 · варіант 2', ust_accent(2)['hex']);
?>
<body>
<div class="sheet">
    ...
    <header class="masthead">
        ...
        <span>Лабораторна робота № 2 · варіант <b>2</b></span>
    ...
    <div class="programs">
        <section class="program">
            ...
            <div>
                <h2>Згортання суми гармонік в одну</h2>
                <p>
        ...
        <section class="program">
            ...
            <div>
                <h2>Адреса мережі</h2>
                <p>
                    Завдання виконує об’єкт класу <code>NetworkAddressTask</code>; параметри
