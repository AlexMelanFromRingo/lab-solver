...
ust_head('ЛР2 · варіант 3', ust_accent(3)['hex']);
?>
<body>
<div class="sheet">
    ...
    <header class="masthead">
        ...
        <span>Лабораторна робота № 2 · варіант <b>3</b></span>
    ...
    <div class="programs">
        <section class="program">
            ...
            <div>
                <h2>Формули суми та різниці синусів у знаменниках</h2>
                <p>
        ...
        <section class="program">
            ...
            <div>
                <h2>Система обчислення</h2>
                <p>
                    Завдання виконує об’єкт класу <code>NumberBaseTask</code>; параметри
