...
ust_head('ЛР2 · варіант 8', ust_accent(8)['hex']);
?>
<body>
<div class="sheet">
    ...
    <header class="masthead">
        ...
        <span>Лабораторна робота № 2 · варіант <b>8</b></span>
    ...
    <div class="programs">
        <section class="program">
            ...
            <div>
                <h2>Квадрат суми та косинус через тангенс половинного кута</h2>
                <p>
        ...
        <section class="program">
            ...
            <div>
                <h2>Площа картинки</h2>
                <p>
                    Завдання виконує об’єкт класу <code>PictureAreaTask</code>; параметри
