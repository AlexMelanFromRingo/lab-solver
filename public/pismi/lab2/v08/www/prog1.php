...
ust_head('ЛР2 · програма № 1 · варіант 8', ust_accent(8)['hex']);
?>
<body>
<div class="sheet">
    ...
    <header class="masthead">
        ...
        <span>Програма № 1 · варіант <b>8</b></span>
    </header>

    <h1 class="title">Квадрат суми та косинус через тангенс половинного кута</h1>
    <p class="subtitle">
    ...
    <div class="split">
        <section class="prose">
            ...
            <p>
                Перший дріб скорочується до sin β + cos β, бо його чисельник – повний
                квадрат: журнал показує, що 1 + sin 2β і (sin β + cos β)² – те саме число.
                Другий дріб є універсальною підстановкою для косинуса. Різниця лишає
                чистий sin β.
            </p>
            <p>
...
<?php foreach (trace_values($beta) as $line) : ?>
