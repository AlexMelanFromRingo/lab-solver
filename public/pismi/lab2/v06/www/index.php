...
<div class="sheet">
    ...
    <header class="masthead">
        ...
        <span>Лабораторна робота № 2 · варіант <b>6</b></span>
    ...
    <div class="programs">
        <section class="program">
            ...
            <div>
                <h2>Скорочення дробу на суму синуса й косинуса</h2>
                <p>
        ...
        <section class="program">
            ...
            <div>
                <h2>Текстове число</h2>
                <p>
                    Завдання виконує об’єкт класу <code>SpelledNumberTask</code>; параметри
