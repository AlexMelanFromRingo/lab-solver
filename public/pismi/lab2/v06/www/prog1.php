...
ust_head('ЛР2 · програма № 1 · варіант 6', ust_accent(6)['hex']);
?>
<body>
<div class="sheet">
    ...
    <header class="masthead">
        ...
        <span>Програма № 1 · варіант <b>6</b></span>
    </header>

    <h1 class="title">Скорочення дробу на суму синуса й косинуса</h1>
    <p class="subtitle">
    ...
    <div class="given">
        y₁ = sin²x / (sin x − cos x) − (sin x + cos x) / (tg²x − 1)<br>
        y₂ = sin x + cos x
