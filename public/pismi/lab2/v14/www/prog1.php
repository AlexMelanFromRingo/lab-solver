...
ust_head('ЛР2 · програма № 1 · варіант 14', ust_accent(14)['hex']);
?>
<body>
<div class="sheet">
    ...
    <header class="masthead">
        ...
        <span>Програма № 1 · варіант <b>14</b></span>
    </header>

    <h1 class="title">Різниця квадратів у двох множниках одразу</h1>
    <p class="subtitle">
    ...
    <div class="given">
        y₁ = (√a/2 − 1/(2√a))² · ((√a − 1)/(√a + 1) − (√a + 1)/(√a − 1))<br>
        y₂ = (1 − a)/√a
    ...
    <div class="split">
        <section class="prose">
            ...
            <p>
                Перший множник – квадрат величини (a − 1)/(2√a), другий після приведення
                до спільного знаменника дає −4√a/(a − 1). У добутку (a − 1)² скорочується
                з (a − 1), а четвірки взаємно знищуються. Журнал наводить обидві згорнуті
                форми поряд із безпосередньо обчисленими, і вони збігаються.
            </p>
            <p>
