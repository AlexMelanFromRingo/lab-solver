...
ust_head('ЛР2 · програма № 1 · варіант 13', ust_accent(13)['hex']);
?>
<body>
<div class="sheet">
    ...
    <header class="masthead">
        ...
        <span>Програма № 1 · варіант <b>13</b></span>
    </header>

    <h1 class="title">Від’ємні та дробові показники степеня</h1>
    <p class="subtitle">
    ...
    <div class="given">
        y₁ = (1 − a⁻²)/(√a − a^(−0,5)) − 2/√(a³) + (a⁻² − a)/(√a − a^(−0,5))<br>
        y₂ = −√a − 2·a^(−1,5)
    ...
    <div class="split">
        <section class="prose">
            ...
            <p>
                Перший і третій доданки мають спільний знаменник (a − 1)/√a. Після
                додавання чисельники дають −a², і весь вираз стягується до −√a – журнал
                показує цю суму окремим рядком. Середній доданок 2/√(a³) – це те саме, що
                2·a^(−1,5), тому відповідь набуває вигляду з умови.
            </p>
            <p>
