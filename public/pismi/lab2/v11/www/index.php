...
ust_head('ЛР2 · варіант 11', ust_accent(11)['hex']);
?>
<body>
<div class="sheet">
    ...
    <header class="masthead">
        ...
        <span>Лабораторна робота № 2 · варіант <b>11</b></span>
    ...
    <div class="programs">
        <section class="program">
            ...
            <div>
                <h2>Заміна змінної під коренем</h2>
                <p>
        ...
        <section class="program">
            ...
            <div>
                <h2>Шахи</h2>
                <p>
                    Завдання виконує об’єкт класу <code>ChessboardTask</code>; параметри
