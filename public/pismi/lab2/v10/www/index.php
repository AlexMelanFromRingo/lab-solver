...
ust_head('ЛР2 · варіант 10', ust_accent(10)['hex']);
?>
<body>
<div class="sheet">
    ...
    <header class="masthead">
        ...
        <span>Лабораторна робота № 2 · варіант <b>10</b></span>
    ...
    <div class="programs">
        <section class="program">
            ...
            <div>
                <h2>Різниця кубів під коренем</h2>
                <p>
        ...
        <section class="program">
            ...
            <div>
                <h2>Піраміда рисунків</h2>
                <p>
                    Завдання виконує об’єкт класу <code>PicturePyramidTask</code>; параметри
