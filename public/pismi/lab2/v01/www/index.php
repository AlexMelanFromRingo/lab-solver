...
ust_head('ЛР2 · варіант 1', ust_accent(1)['hex']);
?>
<body>
<div class="sheet">
    ...
    <header class="masthead">
        ...
        <span>Лабораторна робота № 2 · варіант <b>1</b></span>
    ...
    <div class="programs">
        <section class="program">
            ...
            <div>
                <h2>Зниження степеня через косинус подвійного кута</h2>
                <p>
        ...
        <section class="program">
            ...
            <div>
                <h2>Адреса вузла</h2>
                <p>
                    Завдання виконує об’єкт класу <code>NodeAddressTask</code>; параметри
