...
ust_head('ЛР2 · варіант 12', ust_accent(12)['hex']);
?>
<body>
<div class="sheet">
    ...
    <header class="masthead">
        ...
        <span>Лабораторна робота № 2 · варіант <b>12</b></span>
    ...
    <div class="programs">
        <section class="program">
            ...
            <div>
                <h2>Тангенс половинного кута під коренем</h2>
                <p>
        ...
        <section class="program">
            ...
            <div>
                <h2>Будинок, що збудував Джек</h2>
                <p>
                    Завдання виконує об’єкт класу <code>JackHouseTask</code>; параметри
