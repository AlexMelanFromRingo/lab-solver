...
ust_head('ЛР2 · програма № 1 · варіант 4', ust_accent(4)['hex']);
?>
<body>
<div class="sheet">
    ...
    <header class="masthead">
        ...
        <span>Програма № 1 · варіант <b>4</b></span>
    </header>

    <h1 class="title">Основна тотожність і косинус різниці</h1>
    <p class="subtitle">
    ...
    <div class="split">
        <section class="prose">
            ...
            <p>
                Розкриття дужок дає sin²α + cos²α = 1 та sin²β + cos²β = 1, а подвоєні
                добутки згортаються в косинус різниці. Далі працює формула половинного
                кута. Отже вираз залежить не від самих кутів, а лише від їхньої різниці –
                журнал це підтверджує: 2 + 2·cos(α − β) уже дорівнює відповіді.
            </p>
            <p>
