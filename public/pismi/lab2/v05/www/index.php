...
ust_head('ЛР2 · варіант 5', ust_accent(5)['hex']);
?>
<body>
<div class="sheet">
    ...
    <header class="masthead">
        ...
        <span>Лабораторна робота № 2 · варіант <b>5</b></span>
    ...
    <div class="programs">
        <section class="program">
            ...
            <div>
                <h2>Куби синуса й косинуса через кратні кути</h2>
                <p>
        ...
        <section class="program">
            ...
            <div>
                <h2>Таблиця за цифрами числа</h2>
                <p>
                    Завдання виконує об’єкт класу <code>DigitTableTask</code>; параметри
