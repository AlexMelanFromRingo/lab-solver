...
ust_head('ЛР2 · варіант 7', ust_accent(7)['hex']);
?>
<body>
<div class="sheet">
    ...
    <header class="masthead">
        ...
        <span>Лабораторна робота № 2 · варіант <b>7</b></span>
    ...
    <div class="programs">
        <section class="program">
            ...
            <div>
                <h2>Добуток косинусів суми й різниці</h2>
                <p>
        ...
        <section class="program">
            ...
            <div>
                <h2>Координати комірки</h2>
                <p>
                    Завдання виконує об’єкт класу <code>CellCoordinatesTask</code>; параметри
