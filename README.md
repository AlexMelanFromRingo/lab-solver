...
**Проектирование ИС в сетях Интернет** — лаба 2, программа 1 (15 вариантов): считает
оба выражения варианта прямо по условию и показывает журнал промежуточных величин, из
которого видно, каким преобразованием одно выражение переходит в другое; лаба 2,
программа 2 (13 вариантов): адреса сети и узла в двоичном виде, системы счисления,
календарь, координаты ячейки, шахматная доска, пирамиды, зодиак.
