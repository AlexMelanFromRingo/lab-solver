...
**Математика** — проверка тождеств (15 вариантов): считает оба выражения варианта
прямо по условию и показывает журнал промежуточных величин, из которого видно, каким
преобразованием одно выражение переходит в другое.
